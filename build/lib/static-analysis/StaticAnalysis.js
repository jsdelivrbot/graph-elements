(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(["exports", "../../../node_modules/esprima/esprima.js"], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require("../../../node_modules/esprima/esprima.js"));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.esprima);
        global.StaticAnalysis = mod.exports;
    }
    ...
    class StaticAnalysis {
        static analyze(code) {
            const tree = _esprima2.default.parse(code);
        ...
        */
    }exports.default = StaticAnalysis;
    ;
    class Scope {
