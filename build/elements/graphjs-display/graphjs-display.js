...
_asyncToGenerator(function* () {
    ...
    const dependencies_ready = new Promise((() => {
        var _ref2 = _asyncToGenerator(function* (resolve) {
            yield require_ready;
            require(["../../lib/polymer/Gestures.js", "../../lib/jamtis/requestAnimationFunction.js", "../../lib/early-element/early-element.js"], function (...args) {
                return resolve(args);
            });
        });
    ...
    const style_ready = _asyncToGenerator(function* () {
        ...
        style.textContent = yield (yield fetch(document.currentScript.src + "/../graphjs-display.css")).text();
        return style;
    })();
    const [{
        default: Gestures
                ...
                _updateGraph: {
                    value: requestAnimationFunction(function () {
                        ...
                        for (const [link, path] of updated_paths) {
                            path.setAttribute("d", _this.calcPath(link));
                        }
                    }),
                    configurable: true,
                    writable: true
